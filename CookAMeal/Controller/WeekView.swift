...
@IBDesignable class WeekView: UIView, WeekViewDataSource, WeekViewDelegate, WeekViewStyler, UIInfiniteScrollViewDataSource {
     ...
     */
    init(frame: CGRect, visibleDays: Int, date: DateInRegion = DateInRegion(), startHour: Int , endHour: Int , colorTheme: Theme, nowLineEnabled: Bool , nowLineColor: UIColor) {
    ...
    override init(frame: CGRect) {
        super.init(frame: frame)
        self.commonInit(frame: frame, visibleDays: 5, date: DateInRegion(), startHour: 0, endHour: 24, colorTheme: .light, nowLineEnabled: true, nowLineColor: .red)
    }
